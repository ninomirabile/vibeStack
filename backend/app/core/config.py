...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://vibestack:vibestack@localhost:5432/vibestack"
    ...
    def validate_secret_key(cls, v, values):
        ...
        if values.get("ENVIRONMENT") == "production" and v == "your-super-secret-key-change-this-in-production":
